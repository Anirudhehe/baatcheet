...
const ProfilePage = () => {
  ...
  const [name,setName] = useState("Chamkila Billa")
  const [bio,setBio] = useState("Kya bolti Public");
    ...
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      <div className='w-5/6 max-w-2xl bg-gray-800 text-white border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        <form onSubmit={handleSubmit} action="" className='flex flex-col gap-5 p-10 flex-1'>
          ...
          name="" id="" required placeholder='Write Profile bio...' className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500'></textarea>

          <button className='bg-gradient-to-r from-purple-400 to-violet-600 border border-gray-400 rounded-full p-3 w-fit cursor-pointer' type='submit'>Save Changes</button>
        </form>
